package ru.buduschev.sd.todo.controller;
...
import ru.buduschev.sd.todo.model.TodoItem;
import ru.buduschev.sd.todo.model.TodoItemStatus;
import ru.buduschev.sd.todo.model.TodoList;
import ru.buduschev.sd.todo.utils.Pair;
...
public class TodoListsController {
    ...
    private void prepareModelMapForList(ModelMap map, int listId) {
        ...
        var list = new Pair<>(todoListsJdbcDao.getList(listId), todoListsJdbcDao.getItems(listId));
    ...
    private void prepareModelMap(ModelMap map) {
        ...
        var lists =
                todoLists
                        .stream()
                        .map(list -> new Pair<>(list, todoListsJdbcDao.getItems(list.getId())))
